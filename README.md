...
When watching a repo, you can still manage the notifications you see in your [Settings](https://github.com/settings/notifications). *Filtering* your email is also an effective strategy: you can label/redirect GitHub messinges by sender or repo name, but filter by whether you are @mentioned (by your @username) in the messinge.
