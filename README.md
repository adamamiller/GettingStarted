...
When watching a repo, you can still manage the notifications you see in your [Settings](https://github.com/settings/notifications). *Filtering* your email is always? an effective strategy: you can label/redirect GitHub messages by sender or repo name, but also? by whether you are @mentioned (by your @username) in the message.
